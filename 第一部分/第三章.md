...
![image-20191021151400967](/Users/silver/Library/Application Support/typora-user-images/image-20191021151400967.png)
...
![image-20191021151418178](/Users/silver/Library/Application Support/typora-user-images/image-20191021151418178.png)

仅删除这两个引用中的一个是不够的，因为所有的对象仍然可以访问。

但是，如果我们把这两个都删除，那么我们可以看到再也没有对 John 的引用：

![image-20191021151431980](/Users/silver/Library/Application Support/typora-user-images/image-20191021151431980.png)

对外引用不重要，只有传入引用才可以使对象可达。所以，John 现在无法访问，并且将从内存中释放，同时 John 的所有数据也变得无法访问。

经过垃圾回收：

![image-20191021151444525](/Users/silver/Library/Application Support/typora-user-images/image-20191021151444525.png)
...
![image-20191021151524530](/Users/silver/Library/Application Support/typora-user-images/image-20191021151524530.png)

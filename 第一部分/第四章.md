...
![image-20191022135244126](第四章.assets/image-20191022135244126.png)
...
![image-20191022135317731](第四章.assets/image-20191022135317731.png)
...
![image-20191022135341938](第四章.assets/image-20191022135341938.png)
...
![image-20191206145013921](第四章.assets/image-20191206145013921.png)
...
![image-20191024190705431](第四章.assets/image-20191024190705431.png)
...
![image-20191025165133269](第四章.assets/image-20191025165133269.png)

##### [排除和替换：replacer](https://zh.javascript.info/json#pai-chu-he-ti-huan-replacer)
...
##### [格式化：spacer](https://zh.javascript.info/json#ge-shi-hua-spacer)
...
##### [定制 “toJSON”](https://zh.javascript.info/json#ding-zhi-tojson)
...
##### [reviver 用法](https://zh.javascript.info/json#reviver-yong-fa)
...
- JavaScript 提供序列化成 JSON 的方法 [JSON.stringify](https://developer.mozilla.org/zh/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify)和解析 JSON 方法 [JSON.parse](https://developer.mozilla.org/zh/docs/Web/JavaScript/Reference/Global_Objects/JSON/parse)。
